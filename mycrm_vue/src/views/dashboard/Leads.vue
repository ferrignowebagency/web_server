                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom text-uppercase" style="padding-top:0.75rem; padding-bottom:0.75rem;">
                            <div class="float-left">
                                <b>Totale:</b> <span class="badge bg-primary easyre-badge" id="countTOTAL">50</span>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                <router-link class="dropdown-item" :to="{ name: 'Scheda_annuncio', params: { id: lead.id }}"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i>Dettagli</router-link>
